...
export default function LoginPage() {
	...
	useEffect(() => {
		...
		if (newUser === true) {
			return api.postUser(loggedInUser.username).then((res) => {
				if (res === 200) {
			...
			<main className="log-in">
				<div className="log-in-container">
					<form
						...
						onSubmit={(e) => {
							e.preventDefault();
							const [pre, post] = usernameInputted.split("@");
							return api.findUser(pre).then((result) => {
								if (result !== null) {
					...
					<div className="example-text">
						<h2>
							Feel free to log in with this example user email if you would like
							- <br></br>jessjelly@yahoo.com
						</h2>
					</div>
				</div>
				<div className="disclaimer-text">
					<h4>
						Disclaimer - We will not store any of your personal information
					</h4>
				</div>
			</main>
		);
		...
		return (
			<main>
				<div className="logging-in-container">
					...
					{newUser ? (
						<p>Please take the time to create your first portfolio with us</p>
					) : (
