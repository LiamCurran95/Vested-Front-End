export default function InfoPage(){
    ...
    <main className="info-page">
        ...
        <br></br>
        <cite><a className="cite" href="https://wealthofgeeks.com/wp-content/uploads/2020/09/ESGInvesting.png" target="_blank">Source</a></cite>
        ...
        <ul className="info-esg-list">
            ...
            <cite> <a className="cite" href="https://www.mckinsey.com/business-functions/strategy-and-corporate-finance/our-insights/five-ways-that-esg-creates-value" target="_blank">[McKinsey & Company]</a></cite>
            ...
            <cite > <a className="cite" href="https://www.investopedia.com/terms/e/environmental-social-and-governance-esg-criteria.asp" target="_blank"> [Investopedia]</a></cite>
            ...
            <cite > <a className="cite" href="https://www.cfainstitute.org/en/research/esg-investing" target="_blank"> [CFA Institute] </a></cite>
        
       
            Here are some resources to learn more about ESG criteria and their uses in corporate governance:
            <div className="external-link-container">
                <li > <a className="cite" href="https://assets.publishing.service.gov.uk/government/uploads/system/uploads/attachment_data/file/835214/Sep_2019_bulletin.pdf" target="_blank">GOV.uk</a></li>
                <li> <a className="cite" href="https://www.mckinsey.com/business-functions/strategy-and-corporate-finance/our-insights/five-ways-that-esg-creates-value" target="_blank">McKinsey & Company</a></li>
                <li> <a className="cite" href="https://www.oecd.org/finance/esg-investing.htm" target="_blank">OECD</a></li>
                <li> <a className="cite" href=" https://normative.io/insight/esg-investing-is-gold/" target="_blank">Normative</a></li>
                <li> <a className="cite"href="https://www.forbes.com/advisor/investing/esg-investing/" target="_blank">Forbes</a></li>
                <li> <a className="cite"href="https://www.investopedia.com/terms/e/environmental-social-and-governance-esg-criteria.asp" target="_blank">Investopedia</a></li>
            </div>
        </ul>
