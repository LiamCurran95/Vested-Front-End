export default function InfoPage(){
    ...
    <main className="info-page">
        ...
        <br></br>
        <cite><a className="cite" href="https://wealthofgeeks.com/wp-content/uploads/2020/09/ESGInvesting.png">Source</a></cite>
        ...
        <ul className="info-esg-list">
            ...
            <cite> <a className="cite" href="https://www.mckinsey.com/business-functions/strategy-and-corporate-finance/our-insights/five-ways-that-esg-creates-value">[McKinsey & Company]</a></cite>
            ...
            <li> <a className="cite" href="https://www.oecd.org/finance/esg-investing.htm">OECD</a></li>
            <li> <a className="cite" href=" https://normative.io/insight/esg-investing-is-gold/">Normative</a></li>
            <li> <a className="cite"href="https://www.forbes.com/advisor/investing/esg-investing/">Forbes</a></li>
            <li> <a className="cite"href="https://www.investopedia.com/terms/e/environmental-social-and-governance-esg-criteria.asp">Investopedia</a></li>
        </ul>
